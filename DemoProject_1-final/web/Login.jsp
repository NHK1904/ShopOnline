                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="w-100">
                                        <p class="social-media d-flex justify-content-end">
                                            <a href="https://www.facebook.com/v17.0/dialog/oauth?client_id=793594985493909&redirect_uri=http://localhost:8080/DemoProject_1_bk/facebook-login&scope=email" class="social-icon d-flex align-items-center justify-content-center"><span class="fa fa-facebook"></span></a>
